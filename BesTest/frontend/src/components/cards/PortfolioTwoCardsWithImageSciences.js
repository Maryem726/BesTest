...
export default ({
  ...
  headingHtmlComponent = (
    <>
                  We have some Extra offers for you
    </>
  ),
  description = "",
  ...
  const cards = [
    {
      imageSrc:
        "https://thumbs.dreamstime.com/b/excited-woman-laptop-surprised-african-using-computer-showing-thumbs-up-sitting-lotus-pose-crossed-legs-isolated-vector-203660117.jpg",
      company: "سلسلة تمارين ١",
      type: " حماية البيئة",
      title: "",
    ...
    {
      imageSrc:
        "https://thumbs.dreamstime.com/b/cute-smiling-african-american-girl-using-laptop-computer-desk-online-education-courses-kid-programmer-character-cute-smiling-200005192.jpg",
      company: "سلسلة تمارين ٢",
      type: " تكاثر الحيوانات",
      title: "",

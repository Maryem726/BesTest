...
function PlaceOrderGold(props) {
  const [total, setSearch] = useState(20);
...
//   const navigate = useNavigate();
  ...
  useEffect(() => {
   ...
   console.log(data.data.clientSecret+"eee") 

    };

    fetchClientSecret();
    console.log(fetchClientSecret+"eee") 
...
<CardElement/>
        ...
        <Subtotal>
          ...
          <button onClick={confirmPayment}>Done !</button>
        </Subtotal>
      </Main>
    </Container>
  );

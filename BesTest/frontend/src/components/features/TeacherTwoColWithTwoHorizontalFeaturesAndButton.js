...
export default ({
  ...
  description = "If you think your students could use more practise other than ressources, you can organize catch-up sessions and set your schedules and invite students to take part of the session, you can also host private catch-up sessions if a parent send your a request for one.",
  primaryButtonText = "Host Now",

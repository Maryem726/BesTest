...
const handleChange = (e) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () =>{
      ...
      setLoading(true);
      try {
        const {data: response} = await  Axios.get(`/examen/getbyname/byFrench/${user._id}`)
        setData(response);
      } catch (error) {

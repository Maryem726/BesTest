          ...
          <MainContent>
            ...
            <FormContainer>
              <p tw="mt-6 text-xs text-gray-600 text-center">
                Please provide your unique code in order to access your account !
              </p>
              <Form onSubmit={(e) => onsubmit(e)}>
                <Input type="email"  name='email' value={email} onChange={(e) => hundelchange(e)} required placeholder="Email" />
                <Input type="password" placeholder="Password" name="password" value={password}  minLength='6' required onChange={(e) => hundelchange(e)}/>
              ...
              <p tw="mt-6 text-xs text-gray-600 text-center">
                <a href="../innerPages/ParentSignupPage" tw="border-b border-gray-500 border-dotted">
                   creer un compte  
                </a>
              </p> 

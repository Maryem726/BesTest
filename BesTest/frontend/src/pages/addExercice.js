...
function AddExercice ({
  ...
  AddExercices,Exercice:{exercices,lessons,loading},GetAllLessons
  ...
  <AnimationRevealPage>
    <Container>
      ...
      <LogoLink href={logoLinkUrl}>
          ...
          <FormContainer>
          <p tw="mt-6 text-xs text-gray-600 text-center">Fill up the following form to submit your request for a new exercise !</p>  
          <br/>
          <Form onSubmit={Add} enctype="multipart/form-data">
              ...
              onChange={(event)=>{
               ...
               />
                  ...
                  <select tw="text-gray-500 w-full px-8 py-4 rounded-lg font-medium bg-purple-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5 first:mt-0" className="select-box select-box--primary-style u-w-100" name='lesson'
                  onChange={(event)=>{
...
<Input type="file" placeholder="file" 
  ...
  export default connect(mapStateToProps, {AddExercices,GetAllLessons})(AddExercice);
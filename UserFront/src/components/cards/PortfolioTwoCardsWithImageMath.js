...
export default ({
  ...
  headingHtmlComponent = (
    <>
               <span tw="text-gray-700">We have some extra offers for you</span> 
    </>
  ),
        ...
        <ThreeColumn>
          <HeadingColumn textOnLeft={textOnLeft}>
            <HeadingInfoContainer>
              ...
              <PrimaryLink tw="text-gray-700 hocus:border-primary-500 hocus:text-primary-800 "> 

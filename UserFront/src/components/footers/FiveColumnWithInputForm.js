...
const Container = tw.div`relative bg-transparent text-gray-700 -mb-8 -mx-8 px-8 py-20 lg:py-24`;
const Content = tw.div`max-w-screen-xl mx-auto relative z-10`;
const SixColumns = tw.div`flex flex-wrap text-center sm:text-left justify-center sm:justify-start md:justify-between -mt-12`;

const Column = tw.div`px-4 sm:px-0 sm:w-1/4 md:w-auto mt-12`;

const ColumnHeading = tw.h5`uppercase font-bold text-gray-800`;
...
const CopywrightNotice = tw.p`text-center text-sm sm:text-base mt-8 md:mt-0 font-medium text-gray-800`;
    ...
    <Container>
      <Content>
        ...
        <ThreeColRow>
          ...
          <CopywrightNotice>&copy; 2022 BesTest. All Rights Reserved.</CopywrightNotice>

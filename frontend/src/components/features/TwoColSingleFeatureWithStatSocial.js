    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc="https://i.kym-cdn.com/photos/images/original/000/378/495/ca6.gif" /> : <img src="https://i.kym-cdn.com/photos/images/original/000/378/495/ca6.gif"/>}
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            ...
            <Description tw="text-indigo-800">{description}</Description>
            <PrimaryLink tw="text-indigo-800 hocus:border-pink-700 hocus:text-pink-700 " href={primaryButtonUrl}> 

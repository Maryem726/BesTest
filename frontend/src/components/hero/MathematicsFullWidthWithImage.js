...
export default ({
  ...
  heading = (
    <>
      ...
      <wbr />
      <br />
      <span tw="text-primary-500">Mathematics Subject.</span>
    </>
  ),
  description = "Here you can find the list of different lessons, exercices and exams available in the Mathematics subject."
}) => {
  return (
    <Container>
      <TwoColumn>

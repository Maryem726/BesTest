...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Check",
      description: "Consult our different packs."
    },
    {
      heading: "Buy",
      description: "Pay to have access on the extra documents."
    },
    {
      heading: "GO!",
      description: "Start with the exercices, exams and many other ADVANCED ressources ."
    }
  ];

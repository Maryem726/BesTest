...
import illustration from "images/teacherLogin.gif";
import logo from "images/logoBestest.png";
import { ReactComponent as LoginIcon } from "feather-icons/dist/icons/log-in.svg";
import { components } from "ComponentRenderer";

const Container = tw(ContainerBase)`min-h-screen bg-gradient-to-t from-green-100 to-green-500 text-white font-medium flex justify-center -m-8`;
...
export default ({
  ...
  headingText = "Wish to have a Teacher Account ?",
  submitButtonText = "Create Account",
  SubmitButtonIcon = LoginIcon,
  forgotPasswordUrl = "#",
  TeachersigninUrl = components.innerPages.TeacherLoginPage,
      ...
      <Content>
        <MainContainer>
          ...
          <MainContent>
            ...
            <FormContainer>
                <p tw="mt-6 text-xs text-gray-600 text-center">Fill up the following form to submit your request for a verified teacher account !</p>
              <Form>
              ...
              <p tw="mt-8 text-sm text-gray-600 text-center">
                ...
                <a href={TeachersigninUrl.url} tw="border-b border-gray-500 border-dotted">
                  Sign In
                </a>
              </p>
            </FormContainer>

...
export default ({
  ...
  headingText = "Wish to have a Parent Account ?",
      ...
      <Content>
        <MainContainer>
          ...
          <MainContent>
            ...
            <FormContainer>
                <p tw="mt-6 text-xs text-gray-600 text-center">Fill up the following form to submit your request for a verified parent account !</p>
              <Form>
